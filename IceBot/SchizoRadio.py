...
num_channels = pygame.mixer.get_num_channels(); print(f"Number of available channels: {num_channels}")
channel21 = pygame.mixer.Channel(21); channel21.set_volume(0) # Initially radio is off
